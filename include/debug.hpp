...
#define LOG_WARNING_MSG(is_enabled, fmt, args...)	LOG_MSG(is_enabled, debug::LOG_LEVEL_WARNING,fmt, ##args)
#define LOG_INFO_MSG(is_enabled,	fmt, args...)	LOG_MSG(is_enabled, debug::LOG_LEVEL_INFO,   fmt, ##args)
#define LOG_ERROR_MSG(is_enabled,	fmt, args...)	LOG_MSG(is_enabled, debug::LOG_LEVEL_ERROR,  fmt, ##args)
#define LOG_LINE(is_enabled)						LOG_TRACE_MSG(is_enabled, "%s() (%s:%d)", __FUNCTION__, __FILE__, __LINE__)
#define LOG_MESSAGE(fmt, args...)					LOG_MSG(true, debug::LOG_LEVEL_DEBUG, fmt, ##args)
#define LOG_FUNC(is_enabled, e)						LOG_INFO_MSG(is_enabled, "< %s > %s", __FUNCTION__, e)
