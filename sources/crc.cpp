...
constexpr std::size_t CRC_TABLE_SIZE_256 = 256;

static const u16 CRC_TABLE_0x1021[ CRC_TABLE_SIZE_256 ] =
{
...
static u16 CRC16_base(u16 start_value, const u08* buf, std::size_t len)
{
    u16 crc = start_value;

    for (size_t i = 0; i < len; i++)
    {
        const u16 tmp = (crc >> 8) ^ buf[ i ];
        crc = (crc << 8) ^ CRC_TABLE_0x1021[ tmp ];
    }
